...
```{r stat_count, fig.width=4.5, fig.height=3, out.height="5cm", echo=TRUE, cache=TRUE}
...
\scriptsize この地図は，**`kokudosuuchi`**パッケージを利用して，
国土交通省国土数値情報行政区域データ(N03-170101_01)により描画しました。
