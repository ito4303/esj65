...
-  ggplot2パッケージ
    - \normalsize gg: Grammer of Graphics

\large

- 統一された文法でさまざまな種類のグラフをえがける。
- 関連パッケージもどんどんできている。
    - \normalsize GGally, ggmcmc, ggmap, ggthemes, egg\dots
...
- 開発履歴 \small (https://github.com/tidyverse/ggplot2/releases より)
...
```{r expression,fig.width=4.5,fig.height=2.5,out.height="4.5cm",echo=TRUE}
...
```{r polygon, dev="cairo_pdf", fig.width=4.5, fig.height=3, out.height="3.6cm", echo=TRUE}
