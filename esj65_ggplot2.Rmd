...
set.seed(12)
data1 <- data.frame(x = 1:20, y = rnorm(20, 0, 1))
data2 <- data1 %>%
  mutate(ymin = data1$y + qnorm(0.025, 0, 1),
         ymax = data1$y + qnorm(0.975, 0, 1))
...
p1 + geom_ribbon(data = data2,
                 aes(x = x, ymin = ymin, ymax = ymax), alpha = 0.5)
```
