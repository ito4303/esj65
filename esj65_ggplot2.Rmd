...
>- \LARGE\bfseries → Reproducible Research
...
## アラカシの年輪データ
\footnotesize データ: Itô and Sumida (2017) Allometric and growth data of an evergreen oak, 
...
例) **`stat_count`**: データの頻度分布を計算する
```{r stat_count, fig.width=5, fig.height=2.1, echo=TRUE}
...
p1 + geom_line(data = data2, aes(Year, Filtered),
               colour = "red") +
