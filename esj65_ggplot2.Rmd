...
```{r geom_line1,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r geom_line2,fig.width=5,fig.height=3,out.height="5.5cm",echo = TRUE}
...
```{r geom_line3,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
ggplot(q_data) + geom_line(aes(Year, Diameter))
```

## colourを指定

```{r geom_line4,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r geom_line5,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r boxplot,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r boxplot2,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
ggplot(iris) + geom_boxplot(aes(Species, Sepal.Width)) +
  coord_flip()
```
...
```{r histogram,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
ggplot(iris) +
...
```{r histogram2,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
ggplot(iris) +
  geom_histogram(aes(Sepal.Length, fill = Species),
...
```{r geom_density,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r annotate,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r geom_bar,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
set.seed(1)
...
```{r stat_function,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r stat_count,fig.width=5,fig.height=3,out.height="5cm",echo=TRUE}
...
```{r data21,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r geom_ribbon,fig.width=5,fig.height=3,out.height="4.5cm",echo=TRUE}
...
```{r geom_raster,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
...
```{r geom_contour,fig.width=5,fig.height=3,out.height="5.5cm",echo=TRUE}
